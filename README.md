...
* [BetaML](https://github.com/sylvaticus/BetaML.jl) - Algorithms and utilities to implement machine learning workflows in Julia (classification, regression, clustering, imputation, dimensionality reduction)
